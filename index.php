  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
       ...
       <a href="single_article.php?id=27"> <h1 style="color: #EBE7E7;">HMAS Albatross History</h1></a>
      ...
      <div class="item">
        <img src="img/slider/Slide2.jpg" alt="Chicago" style="width: 100%; height: 100%;">
         <div class="carousel-caption">
       <a href="single_article.php?id=27"> <h1 style="color: #EBE7E7;">HMAS Parramatta departs for a regional presence deployment</h1></a>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
       <a href="single_article.php?id=27"> <h1 style="color: #EBE7E7;">Aviator shares his heritage</h1></a>
